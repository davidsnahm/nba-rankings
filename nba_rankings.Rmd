...
teams <- c("76ers", "Bucks", "Bulls", "Cavaliers", "Celtics", "Clippers", "Grizzlies", "Hawks", "Heat", "Hornets", "Jazz",
           "Kings", "Knicks", "Lakers", "Magic", "Mavericks", "Nets", "Nuggets", "Pacers", "Pelicans", "Pistons",
           "Raptors", "Rockets", "Spurs", "Suns", "Thunder", "Timberwolves", "Trail Blazers", "Warriors", "Wizards", "League Average")
new_cols <- c("#ED174C", "#00471B", "#CE1141", "#860038", "#008348", "#ED174C", "#7399C6", "#E13A3E", "#98002E", "#1D1160", "#002B5C", "#724C9F", "#F58426", "#552582", "#007DC5", "#007DC5", "#061922", "#4D90CD", "#FFC633", "#002B5C", "#ED174C", "#CE1141", "#CE1141", "#8E9090", "#E56020", "#007DC3", "#005083", "#E03A3E", "#FDB927", "#E31837", "#061922")
...
server <- function(input, output) {
  output$chart <- renderChart2({
    ...
    if(input$var == "76ers") {
      ...
      #n$chart(forceX=c(input$range[1], input$range[2]))
